    ...
    if (typeof navigator !== 'undefined' && navigator.share) {
      try {
        ...
        try {
          ...
          // Image capture failed, share without image
        }
  ...
  return (
    <div className="flex flex-col gap-3 w-full mt-6">
      <button
        ...
        className="w-full bg-white text-black font-semibold text-[15px] py-3.5 rounded-2xl active:scale-[0.98] transition-transform flex items-center justify-center gap-2"
      >
